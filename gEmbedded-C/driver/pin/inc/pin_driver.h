...
typedef enum {
    ...
    PIN_DRIVER_ERROR_MAP = 110,
    PIN_DRIVER_ERROR_UNMAP = 111,
    PIN_DRIVER_ERROR_FILE = 112,
    PIN_DRIVER_ERROR_IOCTL = 113,
    PIN_DRIVER_ERROR_IO_POLL = 114,
    PIN_DRIVER_ERROR_IO_POLL_TIMEOUT = 115
} PIN_DRIVER_ERROR;
