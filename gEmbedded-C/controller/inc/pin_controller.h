...
typedef enum {
    ...
    PIN_CONTROLLER_ERROR_INIT_MAP = 1000,
    PIN_CONTROLLER_ERROR_DESTROY_UNMAP = 1001,
    PIN_CONTROLLER_ERROR_PIN_NUMBER = 1002,
    PIN_CONTROLLER_ERROR_PIN_FUNCTION = 1003,
    PIN_CONTROLLER_ERROR_PIN_PULLUPDOWN = 1004,
    PIN_CONTROLLER_ERROR_PIN_EVENT = 1005,
    PIN_CONTROLLER_ERROR_PIN_EVENT_TIMEOUT = 1006,
    PIN_CONTROLLER_ERROR_FILE = 1007,
    PIN_CONTROLLER_ERROR_IOCTL = 1008,
    PIN_CONTROLLER_ERROR_POLL = 1009
